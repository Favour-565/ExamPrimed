  ...
  return (
    <section className="relative min-h-screen w-full overflow-y-auto overflow-x-hidden">
      ...
      <div className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrollPosition > 20 ? 'bg-white/90 backdrop-blur-sm shadow-md' : ''
      }`}>
        <img
          src="/images/logo.png"
          alt="Logo"
      ...
      <div className="relative flex min-h-screen flex-col px-4 pt-24 pb-8 md:px-10 lg:px-16">
          ...
          <div className="rounded-lg bg-white/90 p-4 shadow-lg backdrop-blur-sm md:p-8">
            {loading ? (
              ...
              <div className="text-center">
                ...
                <p className="py-2">Total Questions: {quizResults.totalQuestions}</p>
                <p className="py-2">Correct Answers: {quizResults.correctAnswers}</p>
                <p className="py-2">Incorrect Answers: {quizResults.incorrectAnswers}</p>
                <p className="py-2">Score Accuracy: {quizResults.scoreAccuracy}%</p>
              </div>
            )}
          </div>
        </div>
