...
function Award() {
  // Get quiz results from the passed state via useLocation
  ...
  // Function to handle review answers
  const handleReviewAnswers = () => {
    navigate("/review-answers", { state: { quizResults } }); // Navigate to review page with quiz results
  };

  // Function to handle share score
        ...
        <div className="flex gap-5 max-md:flex-col" style={{ backgroundImage: `url('/images/AwardFrames.png')` }}>
          <div className="flex flex-col w-[61%] max-md:ml-0 max-md:w-full">
            <div className="flex overflow-hidden relative flex-col grow items-center px-20 pt-5 pb-56 rounded-xl min-h-[615px] max-md:px-5 max-md:pb-24 max-md:max-w-full">
              {/* You can add extra content here */}
            </div>
          </div>
          
          {/* Right column for the result display */}
          <div className="flex flex-col ml-5 w-[39%] max-md:ml-0 max-md:w-full">
            <div className="flex relative flex-col items-start mt-24 w-full font-semibold text-zinc-50 max-md:mt-10 max-md:max-w-full">
              ...
              {/* Display the score accuracy and total questions */}
              ...
              {/* Action buttons for review and sharing score */}
