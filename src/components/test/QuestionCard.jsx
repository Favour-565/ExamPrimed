...
import QuestionMarkIcon from '/Icons/emojione-v1_question-mark.png';
    ...
    <div className="w-[50rem] mx-auto mt-2 pt-8 mb-4 bg-[#015758] rounded-xl shadow-md overflow-hidden p-6">
      ...
      <div className="">
        <div className="flex items-center">
          <img src={QuestionMarkIcon} alt="Question Mark" className="w-24 ml-24" />
      ...
      <div className="grid grid-cols-2 gap-5 mx-3">
        {currentQuestion.options.map((option, index) => (
          <div key={index} className="flex items-stretch" onClick={() => handleOptionSelect(option)}>
            <div
            ...
            >
              <span
                ...
                style={{ backgroundColor: selectedOption === option ? '#blue-500' : getOptionColor(index) }}
              >
                {String.fromCharCode(65 + index)}
              </span>
              <span className="flex items-center px-4 bg-white flex-grow">{option}</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="flex justify-end mt-8">
        {!showSubmit ? (
          <button
            ...
            className="bg-[#369D9E] text-white px-8 py-2 rounded-[20px] shadow-md hover:bg-teal-600"
          ...
          <button
            ...
            className="bg-[#369D9E] text-white px-8 py-2 rounded-[20px] shadow-md hover:bg-yellow-600"
          >
            Submit
          </button>
        )}
