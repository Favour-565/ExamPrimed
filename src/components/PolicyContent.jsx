...
function PolicyContent() {
  ...
  const contentData = [
    {
      subHeading: "policies and procedures",
      body: `This Privacy Policy describes Our policies and procedures on the collection, use, and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.Interpretation and Definitions,
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to MARTAD EDU $ SKILLS, 3B ALEGBE CLOSE, MENDE, MARYLAND, LAGOS, NIGERIA.
...
The website refers to ExamPrimed, accessible from https://examprimed.com/
...
`,
    },
    {
      ...
      body: `To manage Your requests: To attend and manage Your requests to Us.
...
By visiting this page on our website: https://examprimed/contact-us/
`,
    },
  ];
        ...
        {contentData.map((content, index) => (
          <div key={index} className="flex flex-col w-6/12 max-md:w-full">
            <div className="text-base text-black">
              <h2 className="font-bold text-lg mb-4">{content.subHeading}</h2>
