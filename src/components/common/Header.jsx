...
const DesktopHeader = ({ isScrolled }) => {
  return (
    <>
      <header
        className={`fixed inset-0 z-20 hidden h-fit w-full py-2.5 transition-colors duration-300 ease-in-out lg:block ${isScrolled ? "bg-white text-black shadow-lg" : "bg-transparent text-white"}`}
      >
